    ...
    if goal == 'Improve Speaking':
        if level == 'Advanced':
            if time == 'Long':
                ...
                module = 'Advanced Speaking - Quick Tips'
        else:
            module = 'Basic Speaking Module '
    elif goal == 'Improve Reading':
        module = 'Reading Module '
    elif goal == 'Improve Listening':
        module = 'Listening Module Based on Time Available'
    elif goal == 'Improve Writing':
        module = 'Writing Module Based on Level and Study Method'
    elif goal == 'IELTS Preparation':
        module = 'IELTS Tests'
    elif goal == 'Job Interview Preparation':
        module ='Job interview simulator'
    else:
